...
async function handleMultiSessionSubmit(e) {
      ...
      if (appState.sessionPerformances && appState.sessionPerformances.length > 0) {
        appState.sessionPerformances.forEach((perf, pIdx) => {
          ...
          const snapClone = JSON.parse(JSON.stringify(perf));
          snapClone.smoothness = Number(perf.smoothness || 0);
          snapClone.footwork = Number(perf.footwork || 0);
          snapClone.notes = perf.notes || globalNotes;
          ...
          const perfRecord = {
            ...
            performanceSnapshot: snapClone,
            performanceScore: perfScore.totalScore,
            smoothnessScore: Number(perf.smoothness || 0),
            footworkScore: Number(perf.footwork || 0),
